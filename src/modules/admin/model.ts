...
export class Model extends BaseModel<ModuleState, APPState> {
  ...
  @reducer
  public putSiderCollapsed(siderCollapsed: boolean): void {
    this.state.siderCollapsed = siderCollapsed;
  }
  ...
  @reducer
  public closeTabEditor(): void {
    this.state.tabEdit = undefined;
  }
