...
import {DStatus, ListItem, ListSearch, Status, defaultListSearch} from '../entity';
...
const mapStateToProps: (state: APPState) => StoreProps = (state) => {
  const {listSearch, list, pagination, listLoading} = state.article!;
  console.log('ListTable----> mapStateToProps invoked' + JSON.stringify(list));
